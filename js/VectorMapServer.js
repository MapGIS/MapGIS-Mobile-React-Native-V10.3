...
export default class VectorMapServer extends MapServer{
     ...
     */
    async getVectorImage(imgWidth, imgHeight, disPRectXMin, disPRectYMin, disPRectXMax, disPRectYMax){
        try {
            let buf = await VMS.getVectorImage(this._MGVectorMapServerId, imgWidth, imgHeight, disPRectXMin, disPRectYMin, disPRectXMax, disPRectYMax);
            return buf;
        } catch (e) {
            console.error(e);
        }
