...
export default class VectorLabel extends Label{
    ...
    async getPntPlaceInfo(){
        try {
            var {PointPlaceInfoId} = await VL.getPntPlaceInfo(this._MGVectorLabelId);
    ...
    async setPntPlaceInfo(){
        try {
            await VL.setPntPlaceInfo(this._MGVectorLabelId, pointPlaceInfo._MGPointPlaceInfoId);
    ...
    async setLinPlaceInfo(){
        try {
            await VL.setLinPlaceInfo(this._MGVectorLabelId, linPlaceInfo._MGLinePlaceInfoId);
    ...
    async setRegPlaceInfo(regPlaceInfo){
        try {
            await VL.setRegPlaceInfo(this._MGVectorLabelId, regPlaceInfo._MGRegionPlaceInfoId);
