...
//    }
    ...
    async getZoomCapacity(minZoom, maxZoom){
        try {
            let result = await TMS.getZoomCapacity(this._MGTileMapServerId, minZoom._MGIntUserId, maxZoom._MGIntUserId);
            return result;
        } catch (e) {
            console.error(e);
        }
    ...
    async getTileSize(width, height){
        try {
            let result = await TMS.getTileSize(this._MGTileMapServerId, width._MGIntUserId, height._MGIntUserId);
            return result;
        } catch (e) {
            console.error(e);
        }
    ...
    async setTileResolution(zoom, dResolution){
        try {
            let result = await TMS.setTileResolution(this._MGTileMapServerId, zoom, dResolution);
            return result;
        } catch (e) {
            console.error(e);
        }
    ...
    async getTileResolution(zoom){
        try {
            let tileResolution = await TMS.getTileResolution(this._MGTileMapServerId, zoom);
    ...
    async getGroundResolution(zoom, dLogY){
        try {
            let groundResolution = await TMS.getGroundResolution(this._MGTileMapServerId, zoom, dLogY);
...
//    }
    ...
    async getTileImage(row, col, zoom){
        try {
            let array = await TMS.getTileImage(this._MGTileMapServerId, row, col, zoom);
            return array;
        } catch (e) {
            console.error(e);
        }
