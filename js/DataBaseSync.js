...
//   }
  ...
  /**
	 ...
	 */
	static async createDefaultDownloadDataBaseParmeters(strIGServerBaseURL, strDocName, mapID, extent)
	{
		try {
            let {DownloadDataBaseParmetersId} = await DBSC.createDefaultDownloadDataBaseParmeters(strIGServerBaseURL, strDocName, mapID, extent._MGRectId); 
	...
	{
		try {
            let {SyncDataBaseParmetersId} = await DBSC.createDefaultSyncDataBaseParmeters(database._MGDataBaseId); 
	...
	{
		try {
            let {MapServiceInfoId} = await DBSC.getMapServiceInfo(strIGServerBaseURL, strDocName, mapID); 
	 ...
	 */
	static async downloadASync(strIGServerBaseURL, strDocName, mapID, params, strPath)
	{
		try {
