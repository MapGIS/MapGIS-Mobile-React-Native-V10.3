...
export default class SpaRelation{
 ...
 /**
  ...
  async getTolerance()
	...
	{
		try {
            return await SPR.isLinInReg(lin._MGGeoVarLineId, reg._MGGeoPolygonId, esp);
          } catch (e) {
            console.error(e);
        }
	}
	...
	{
		try {
            return await SPR.isRegInReg(reg0._MGGeoPolygonId, reg1._MGGeoPolygonId, esp);
          } catch (e) {
            console.error(e);
        }
	}
	...
	{
		try {
            return await SPR.isRegInterReg(reg0._MGGeoPolygonId, reg1._MGGeoPolygonId);
          } catch (e) {
            console.error(e);
        }
	}
	...
	{
		try {
            return await SPR.isContains(this._MGSpaRelationId, geom0._MGGeometryId, geom1._MGGeometryId);
          } catch (e) {
            console.error(e);
        }
	}
	...
	{
		try {
            return await SPR.isCrosses(this._MGSpaRelationId, geom0._MGGeometryId, geom1._MGGeometryId);
          } catch (e) {
            console.error(e);
        }
	}
	...
	{
		try {
            return await SPR.isDisjoint(this._MGSpaRelationId, geom0._MGGeometryId, geom1._MGGeometryId);
          } catch (e) {
            console.error(e);
        }
	}
	...
	{
		try {
            return await SPR.isEquals(this._MGSpaRelationId, geom0._MGGeometryId, geom1._MGGeometryId);
          } catch (e) {
            console.error(e);
        }
	}
	...
	{
		try {
            return await SPR.isOverlaps(this._MGSpaRelationId, geom0._MGGeometryId, geom1._MGGeometryId);
          } catch (e) {
            console.error(e);
        }
	}
	...
	{
		try {
            return await SPR.isTouches(this._MGSpaRelationId, geom0._MGGeometryId, geom1._MGGeometryId);
          } catch (e) {
            console.error(e);
        }
	}
	...
	{
		try {
            return await SPR.isWithin(this._MGSpaRelationId, geom0._MGGeometryId, geom1._MGGeometryId);
          } catch (e) {
            console.error(e);
        }
	}
