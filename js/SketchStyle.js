...
export default class SketchStyle{
    ...
    */
    async setVertexStyle(vertexPointStyle){
        try {
            await SS.setVertexStyle(this._MGSketchStyleId, vertexPointStyle._MGPointStyleId);
    ...
    */
    async setMidVertexStyle(midVertexPointStyle){
        try {
            await SS.setMidVertexStyle(this._MGSketchStyleId, midVertexPointStyle._MGPointStyleId);
   ...
   async getReferenceVertexStyle(){
    try {
        let pointStyleId = await SS.getReferenceVertexStyle(this._MGSketchStyleId);
        var pointStyle = new PointStyle();
        pointStyle._MGPointStyleId = pointStyleId;
        return pointStyle;
    } catch (e) {
    ...
    */
    async setReferenceVertexStyle(referenceVertexPointStyle){
        try {
            await SS.setReferenceVertexStyle(this._MGSketchStyleId, referenceVertexPointStyle._MGPointStyleId);
    ...
    */
    async setReferenceLineStyle(lineStyle){
        try {
            await SS.setReferenceLineStyle(this._MGSketchStyleId, lineStyle._MGLineStyleId);
    ...
    */
    async setSelectedVertexStyle(selectedVertexPointStyle){
        try {
            await SS.setSelectedVertexStyle(this._MGSketchStyleId, selectedVertexPointStyle._MGPointStyleId);
   ...
   async getSelectedMidVertexStyle(){
        try {
            let pointStyleId = await SS.getSelectedMidVertexStyle(this._MGSketchStyleId);
            var pointStyle = new PointStyle();
            pointStyle._MGPointStyleId = pointStyleId;
            return pointStyle;
        } catch (e) {
    ...
    */
    async setSelectedMidVertexStyle(selectedMidVertexPointStyle){
        try {
            await SS.setSelectedMidVertexStyle(this._MGSketchStyleId, selectedMidVertexPointStyle._MGPointStyleId);
    ...
    async isShowSegmentLength(){
        try {
            let isShowSegmentLength = await SS.isShowSegmentLength(this._MGSketchStyleId);
    ...
    async isVibrationEnabled(){
        try {
            let isVibrationEnabled = await SS.isVibrationEnabled(this._MGSketchStyleId);
