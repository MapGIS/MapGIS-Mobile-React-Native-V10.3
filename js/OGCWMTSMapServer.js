...
export default class OGCWMTSMapServer extends TileMapServer{
    ...
    async getLayerMatrixSetNames(layerIndex){
        try {
            let layerMatrixSetNames = await OGCWMTSM.getLayerMatrixSetNames(this._MGOGCWMTSMapServerId, layerIndex);
    ...
    async getCurLayerName(){
        try {
            let curLayerName = await OGCWMTSM.getCurLayerName(this._MGOGCWMTSMapServerId);
            return curLayerName;
        } catch (e) {
            console.error(e);
        }
    ...
    async getCurTileMatrixSetName(){
        try {
            let curTileMatrixSetName = await OGCWMTSM.getCurTileMatrixSetName(this._MGOGCWMTSMapServerId);
    ...
    async getCurStyleName(){
        try {
            let curStyleName = await OGCWMTSM.getCurStyleName(this._MGOGCWMTSMapServerId);
            return curStyleName;
        } catch (e) {
            console.error(e);
        }
    ...
    async setCurLayerInfo(layerName, matrixSetName, styleName){
        try {
            await OGCWMTSM.setCurLayerInfo(this._MGOGCWMTSMapServerId, layerName, matrixSetName, styleName);
        } catch (e) {
            console.error(e);
        }
    }
