...
export default class RegionPlaceInfo{
    ...
    async getTryLabelOutside(){
        try {
            let tryLabelOutside = await RPI.getTryLabelOutside(this._MGRegionPlaceInfoId);
    ...
    async getLimitLabelSmallRegion(){
        try {
            let limitLabelSmallRegion = await RPI.getLimitLabelSmallRegion(this._MGRegionPlaceInfoId);
    ...
    async setLimitLabelSmallRegion(limitLabelSmallRegion){
        try {
            await RPI.setLimitLabelSmallRegion(this._MGRegionPlaceInfoId, limitLabelSmallRegion);
        } catch (e) {
            console.error(e);
        }
    }
    ...
    async getSmallRegionMaxArea(){
        try {
            let smallRegionMaxArea = await RPI.getSmallRegionMaxArea(this._MGRegionPlaceInfoId);
    ...
    async setSmallRegionMaxArea(smallRegionMaxArea){
        try {
            await RPI.setSmallRegionMaxArea(this._MGRegionPlaceInfoId, smallRegionMaxArea);
        } catch (e) {
            console.error(e);
        }
    }
