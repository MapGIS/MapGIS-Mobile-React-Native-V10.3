...
export default class MultiClassThemeInfo{
    ...
    async copy(multiClassThemeInfo){
        try {
            let result = await MTI.copy(this._MGMultiClassThemeInfoId,multiClassThemeInfo._MGMultiClassThemeInfoId);
            return result;
        } catch (e) {
            console.error(e);
        }
    ...
    async setValue(index, classItemValue){
        try {
            let result = await MTI.setValue(this._MGMultiClassThemeInfoId,index, classItemValue._MGClassItemValueId);
            return result;
        } catch (e) {
            console.error(e);
        }
    ...
    async getValue(index){
        try {
            var {ClassItemValueId} = await MTI.getValue(this._MGMultiClassThemeInfoId, index);
