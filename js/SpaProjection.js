...
export default class SpaProjection{
 ...
 /**
  ...
  async createObj() {
	...
	{
		try {
            return await SPP.setSourcePara(this._MGSpaProjectionId, sRef._MGSRefDataId);
          } catch (e) {
            console.error(e);
        }
	}
	...
	{
		try {
            return await SPP.setDestinationPara(this._MGSpaProjectionId, sRef._MGSRefDataId);
          } catch (e) {
            console.error(e);
        }
	}
	...
	{
		try {
            let {SRefDataId} = await SPP.getDestinationPara(this._MGSpaProjectionId);
            var sRefData = new SRefData();
            sRefData._MGSRefDataId = SRefDataId;
            return sRefData;
          } catch (e) {
	...
	{
		try {
            return await SPP.setEllipTransParam(this._MGSpaProjectionId, param._MGElpTransParamId);
          } catch (e) {
            console.error(e);
        }
	}
