...
export default class GeometryParams{
    ...
    async setPreCurrentTotalVertex(preCurrentTotalVertex){
        try {
            await GP.setPreCurrentTotalVertex(this._MGGeometryParamsId, preCurrentTotalVertex);
    ...
    async setCurrentVertexIndex(currentVertexIndex){
        try {
            await GP.setCurrentVertexIndex(this._MGGeometryParamsId, currentVertexIndex);
