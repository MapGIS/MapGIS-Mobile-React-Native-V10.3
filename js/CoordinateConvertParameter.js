...
export default class CoordinateConvertParameter{
    ...
    async getDestCoordinateType(){
        try {
            let destCoordinateType = await CCP.getDestCoordinateType(this._MGCoordinateConvertParameterId);
    ...
    async setDestCoordinateType(destCoordinateType){
        try {
            var {CoordinateConvertParameterId} = await CCP.setDestCoordinateType(this._MGCoordinateConvertParameterId, destCoordinateType);
            var coordinateConvertParameter = new CoordinateConvertParameter();
            coordinateConvertParameter._MGCoordinateConvertParameterId = CoordinateConvertParameterId;
            return coordinateConvertParameter;
        } catch (e) {
    ...
    async getSrcCoordinateType(){
        try {
            let srcCoordinateType = await CCP.getSrcCoordinateType(this._MGCoordinateConvertParameterId);
    ...
    async setSrcCoordinateType(srcCoordinateType){
        try {
            var {CoordinateConvertParameterId} = await CCP.setSrcCoordinateType(this._MGCoordinateConvertParameterId, srcCoordinateType);
            var coordinateConvertParameter = new CoordinateConvertParameter();
            coordinateConvertParameter._MGCoordinateConvertParameterId = CoordinateConvertParameterId;
            return coordinateConvertParameter;
        } catch (e) {
