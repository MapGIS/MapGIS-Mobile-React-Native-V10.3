...
export default class MultiClassTheme extends VectorTheme{
    ...
    async setDefaultInfo(themeInfo){
        try {
            await MCT.setDefaultInfo(this._MGMultiClassThemeId, themeInfo._MGThemeInfoId);
    ...
    async getAllOtherDataItemInfoSource(){
        try {
            let itemCount = await MCT.getAllOtherDataItemInfoSource(this._MGMultiClassThemeId);
            return itemCount;
        } catch (e) {
            console.error(e);
        }
    ...
    async setAllOtherDataItemInfoSource(allOtherDataItemInfoSource){
        try {
            await MCT.setAllOtherDataItemInfoSource(this._MGMultiClassThemeId, allOtherDataItemInfoSource);
        } catch (e) {
            console.error(e);
        }
    }
    ...
    async appendExpression(exp, classItemType){
        try {
            let index = await MCT.appendExpression(this._MGMultiClassThemeId, exp, classItemType);
            return index;
        } catch (e) {
            console.error(e);
        }
    ...
    async exchangeExpressions(index1, index2){
        try {
            let result = await MCT.exchangeExpressions(this._MGMultiClassThemeId, index1, index2);
            return result;
        } catch (e) {
            console.error(e);
        }
    ...
    async getExpressionClassItemType(exp){
        try {
            let type = await MCT.getExpressionClassItemType(this._MGMultiClassThemeId, exp);
            return type;
        } catch (e) {
            console.error(e);
        }
    ...
    async appendSubItem(exp, classItemValue){
        try {
            let index = await MCT.appendSubItem(this._MGMultiClassThemeId, exp, classItemValue._MGClassItemValueId);
            return index;
        } catch (e) {
            console.error(e);
        }
    ...
    async removeSubItem(exp, index){
        try {
            let result = await MCT.removeSubItem(this._MGMultiClassThemeId, exp, index);
            return result;
        } catch (e) {
            console.error(e);
        }
    ...
    async mergeSubItem(exp, index, count){
        try {
            let result = await MCT.mergeSubItem(this._MGMultiClassThemeId, exp, index, count);
            return result;
        } catch (e) {
            console.error(e);
        }
    ...
    async splitSubItem(exp, index, splitValue){
        try {
            let result = await MCT.splitSubItem(this._MGMultiClassThemeId, exp, index, splitValue);
            return result;
        } catch (e) {
            console.error(e);
        }
    ...
    async indexOfSubItem(exp, itemValue){
        try {
            let index = await MCT.indexOfSubItem(this._MGMultiClassThemeId, exp, itemValue);
            return index;
        } catch (e) {
            console.error(e);
        }
    ...
    async setSubItemValue(exp, index, classItemValue){
        try {
            let result = await MCT.setSubItemValue(this._MGMultiClassThemeId, exp, index, classItemValue._MGClassItemValueId);
            return result;
        } catch (e) {
            console.error(e);
        }
    ...
    async getSubItemValue(exp, index){
        try {
            var {ClassItemValueId} = await MCT.getSubItemValue(this._MGMultiClassThemeId, exp, index);
    ...
    async make(maintainExistentStyle){
        try {
            let result = await MCT.make(this._MGMultiClassThemeId, maintainExistentStyle);
            return result;
        } catch (e) {
            console.error(e);
        }
    ...
    async getItem(index){
        try {
            var {MultiClassThemeInfoId} = await MCT.getItem(this._MGMultiClassThemeId, index);
    ...
    async setItem(index, multiClassThemeInfo){
        try {
            let result = await MCT.setItem(this._MGMultiClassThemeId, index, multiClassThemeInfo._MGMultiClassThemeInfoId);
            return result;
        } catch (e) {
            console.error(e);
        }
