...
export default class GeneralVectorLabel extends VectorLabel{
    ...
    async getLabelExpression(){
        try {
            let labelExpression = await GVL.getLabelExpression(this._MGGeneralVectorLabelId);
    ...
    async setLabelExpression(labelExpression){
        try {
            await GVL.setLabelExpression(this._MGGeneralVectorLabelId, labelExpression);
    ...
    async getLabelBackType(){
        try {
            let labelBackType = await GVL.getLabelBackType(this._MGGeneralVectorLabelId);
    ...
    async getNumericPrecision(){
        try {
            let numericPrecision = await GVL.getNumericPrecision(this._MGGeneralVectorLabelId);
    ...
    async setNumericPrecision(numericPrecision){
        try {
            await GVL.setNumericPrecision(this._MGGeneralVectorLabelId, numericPrecision);
        } catch (e) {
            console.error(e);
        }
    }
    ...
    async getNewLineToLabel(){
        try {
            let newLineToLabel = await GVL.getNewLineToLabel(this._MGGeneralVectorLabelId);
    ...
    async getMaxLengthPreLine(){
        try {
            let maxLengthPreLine = await GVL.getMaxLengthPreLine(this._MGGeneralVectorLabelId);
    ...
    async setMaxLengthPreLine(maxLengthPreLine){
        try {
            await GVL.setMaxLengthPreLine(this._MGGeneralVectorLabelId, maxLengthPreLine);
        } catch (e) {
            console.error(e);
        }
    }
