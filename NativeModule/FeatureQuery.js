...
export default class FeatureQuery {
    ...
    async getSpatialFilterRelationship() {
        try {
            let {spatialFilterRelationship} = await F.getSpatialFilterRelationship(this._MGFeatureQueryId);
    ...
    async isReturnGeometry() {
        try {
            let {isReturnGeometry} = await F.isReturnGeometry(this._MGFeatureQueryId);
    ...
    async isReturnAttribute() {
        try {
            let {isReturnAttribute} = await F.isReturnAttribute(this._MGFeatureQueryId);
